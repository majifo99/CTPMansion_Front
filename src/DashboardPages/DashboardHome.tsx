...
const DashboardHome: React.FC = () => {
  ...
  return (
    <div className="p-6 bg-gradient-to-b from-gray-50 to-indigo-100 min-h-screen">
      <h2 className="text-4xl font-bold text-gray-700 mb-8">Bienvenido al Dashboard</h2>

      {/* Redesigned Quick Links Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Link to="/dashboard/solicitar-sala" className="bg-blue-500 text-white rounded-lg p-6 shadow-lg flex items-center hover:shadow-xl transition duration-200">
        ...
        <Link to="/dashboard/roles" className="bg-green-500 text-white rounded-lg p-6 shadow-lg flex items-center hover:shadow-xl transition duration-200">
        ...
        <Link to="/dashboard/eventos" className="bg-orange-500 text-white rounded-lg p-6 shadow-lg flex items-center hover:shadow-xl transition duration-200">
        ...
        <Link to="/dashboard/orden-de-pedido" className="bg-purple-500 text-white rounded-lg p-6 shadow-lg flex items-center hover:shadow-xl transition duration-200">
