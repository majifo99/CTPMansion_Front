      ...
      <ConfirmationModal
        ...
        message={
          pendingAction === 'approve'
            ? '¿Estás seguro que deseas aprobar esta solicitud de laboratorio?'
            : '¿Estás seguro que deseas rechazar esta solicitud de laboratorio? Esta acción no se puede deshacer.'
        }
