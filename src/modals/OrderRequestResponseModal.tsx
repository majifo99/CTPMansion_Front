...
interface OrderRequestResponseModalProps {
  isOpen: boolean;
  title: string;
...
const OrderRequestResponseModal: React.FC<OrderRequestResponseModalProps> = ({
  isOpen,
  title,
  action,
  onConfirm,
...
export default OrderRequestResponseModal;
