...
interface RoomHistoryDetailsModalProps {
  isOpen: boolean;
  onClose: () => void;
  request: RoomRequest;
}

const RoomHistoryDetailsModal: React.FC<RoomHistoryDetailsModalProps> = ({ isOpen, onClose, request }) => {
            ...
            <table className="table-auto w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-100">
                  <th className="px-4 py-3 text-gray-600 font-medium text-center">Sala</th>
                  <th className="px-4 py-3 text-gray-600 font-medium text-center">Asistentes</th>
                </tr>
              </thead>
              <tbody>
                <tr className="hover:bg-gray-50">
                  <td className="px-4 py-3 border-b text-center">{request.roomName || 'Desconocida'}</td>
...
export default RoomHistoryDetailsModal;