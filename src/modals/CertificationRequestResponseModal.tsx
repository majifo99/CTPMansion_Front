...
interface CertificationRequestResponseModalProps {
  isOpen: boolean;
  title: string;
...
const CertificationRequestResponseModal: React.FC<CertificationRequestResponseModalProps> = ({
  isOpen,
  title,
  action,
  onConfirm,
...
export default CertificationRequestResponseModal;
