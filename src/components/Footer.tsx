...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-100 via-[#A4C2A5] to-gray-100 py-16">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="lg:col-span-2 grid grid-cols-2 gap-8">
            {/* Dirección */}
            <div>
              <h3 className="font-semibold text-lg text-gray-800">Nuestra Dirección</h3>
            ...
            {/* Horario */}
            <div>
              <h3 className="font-semibold text-lg text-gray-800">Horario</h3>
              <p className="mt-4 text-sm text-gray-600">
            ...
            <div className="lg:col-span-2">
              <h3 className="font-semibold text-lg text-gray-800">Contacto</h3>
              <p className="mt-4 text-sm text-gray-600">
                Correo: <a href="mailto:info@example.com" className="hover:underline">info@example.com</a> <br />
                Teléfono: <a href="tel:+5061234567" className="hover:underline">+506 1234 567</a>
              </p>
            </div>
          </div>
        </div>
        {/* Línea de Separación y Derechos Reservados */}
        <div className="mt-12 border-t border-gray-300 pt-8 text-center text-xs text-gray-600">
